...
{setwd("/Users/dhourani/Dropbox/Transport Program/Project - Spatial structure of cities/Spatial structure/Output/Tables/HILDA")
  ...
  setwd("/Users/jaha/Dropbox (Grattan Institute)/Transport Program/Project - Spatial structure of cities/Spatial structure/Output/Tables/HILDA")}
...
#Get rid of unreasonable looking commute times ie. more than 3 hours each way
commute_data <- commute_data[commute.time < 6 * 60] 
